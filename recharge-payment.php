        ...
        <div class="rounded-xl overflow-hidden ">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-8 md:p-12 mt-12">
                    <p class="font-semi-bolder text-primary-600 font-bold">Recharge & Payment</p>
                    <h1 class="text-4xl font-bold text-secondary-500 ">Mobile & DTH Recharge</h1>
                ...
                <div class="relative max-w-5xl mx-auto  ">
                    ...
                    <div class="relative z-20">
                        <img src="assets/images/recharge-payment/banner.png" alt="Dashboard" class=" h-auto" />
    ...
    <div class="space-y-4">
        ...
        $faqItems = [
            [
                ...
                'answer' => 'Its a simple banking system that uses Aadhaar card and fingerprint to help customers withdraw cash, check balance, and get mini statements.',
                'isOpen' => true
            ],
            [
...
<script>
   ...
   <section class="relative py-10 px-4 sm:px-8 md:px-16 lg:px-20">
            <div class="container mx-auto">
                ...
                <div class="bg-gradient-to-br from-primary-700 to-primary-600 rounded-xl p-6 sm:p-8 md:p-10 text-white relative overflow-hidden" data-aos="fade-up" data-aos-duration="1000">
