...
<body class="bg-white font-inter">
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <section class="w-full bg-primary-600 py-10 px-4" data-aos="fade-up" data-aos-duration="1000">
    <div class="max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row items-start">
            <!-- Section Title -->
            <div class="text-white mb-10 md:mb-0 md:w-1/4 md:mr-8 md:pt-2" data-aos="fade-right" data-aos-duration="1200">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-6 gap-y-8 md:w-3/4 w-full">
                <!-- AEPS -->
                <div class="flex flex-col items-center justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                ...
                <!-- DMT -->
                <div class="flex flex-col items-center justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    <div class="w-28 h-28 rounded-2xl bg-secondary-500 flex items-center justify-center mb-4">
                ...
                <!-- Micro ATM -->
                <div class="flex flex-col items-center justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                    <div class="w-28 h-28 rounded-2xl bg-secondary-500 flex items-center justify-center mb-4">
                ...
                <!-- mPOS -->
                <div class="flex flex-col items-center justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                    <div class="w-28 h-28 rounded-2xl bg-secondary-500 flex items-center justify-center mb-4">
                ...
                <!-- CMS -->
                <div class="flex flex-col items-center justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                    <div class="w-28 h-28 rounded-2xl bg-secondary-500 flex items-center justify-center mb-4">
                ...
                <!-- UPI QR Code -->
                <div class="flex flex-col items-center justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                    <div class="w-28 h-28 rounded-2xl bg-secondary-500 flex items-center justify-center mb-4">
