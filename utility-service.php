...
<body class="bg-white font-inter">
    ...
    <main>
                ...
                <div class="rounded-xl overflow-hidden  ">
                    <div class="grid grid-cols-1 md:grid-cols-2 ">
                        ...
                        <div class="p-8 md:p-12 mt-24">
                            <p class="font-semi-bolder text-primary-900 "><span class="text-primary-500">Home / Multi
                                    Services Platform /</span> Utility</p>
        ...
        <section class="bg-white py-10 px-4 md:px-24">
            <div class="container mx-auto px-6 text-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div
                        class="border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        <img src="assets/images/utility-servises/multi-support.png" alt="Real-Time Payment"
                            class="w-full object-contain rounded-t-lg">
                        <div class="p-6 text-left">
                    ...
                    <div
                        class="border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        <img src="assets/images/utility-servises/smart.png" alt="Real-Time Payment"
                            class="w-full object-contain rounded-t-lg">
                        <div class="p-6 text-left">
        ...
        <section class="bg-secondary-100 text-gray-800 py-10 px-4 md:px-24 flex items-cente">
                        ...
                        <div class="p-8 flex flex-col h-full">
                            ...
                            <div class="flex items-center mb-6">
                                <div class="w-16 h-16 bg-primary-100 rounded-lg flex items-center justify-center mr-4">
                                    <div
                                        class="w-10 h-10 rounded-full bg-gradient-to-r from-primary-500 to-white overflow-hidden flex">
                                        <img src="assets/images/utility-services-page/icon3.png"
            ...
            <div class="container mx-auto px-4 md:px-6 py-16 lg:py-20">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="lg:col-span-5 space-y-6 animate-fade-in">
                        ...
                        <div class="pt-4">
                            <a href="#"
                                class="inline-block bg-white text-secondary-600 font-medium py-3 px-8 rounded-md transition duration-300">Partner
                                With Us</a>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-7 animate-fade-in" style="animation-delay: 0.2s;">
                        <div class="grid grid-cols-2 h-full">
                            ...
                            <div class="flex flex-col h-full">
                                <!-- Top Stat -->
                                <div
                                    class="border-r border-l border-b border-white flex flex-col items-center justify-center py-6 md:py-12">
                                ...
                                <!-- Bottom Stat -->
                                <div
                                    class="border-r border-l border-white flex flex-col items-center justify-center py-6 md:py-12">
                                    <div class="text-center text-sm md:text-base mt-2 text-white/80">
                            ...
                            <div class="flex flex-col h-full">
                                ...
                                <div
                                    class="border-r border-b border-white flex flex-col items-center justify-center py-6 md:py-12 bg-white">
                                ...
                                <!-- Bottom Stat -->
                                <div
                                    class="border-r border-t border-white flex flex-col items-center justify-center py-6 md:py-12">
                                    <div class="text-center text-sm md:text-base mt-2 text-white/80">
