        ...
        <div class="rounded-xl overflow-hidden ">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-8 md:p-12 mt-12">
                    <p class="font-semi-bolder text-primary-600 font-bold">IRCTC Agent ID</p>
                    <h1 class="text-4xl font-bold text-secondary-500 ">IRCTC Agent ID
                    </h1>
                    <h1 class="text-4xl font-bold text-secondary-500 mb-4">Platform</h1>
                    <p class="text-gray-500 mb-8">Partner with us to bring train ticket booking services to your local community.</p>
                ...
                <div class="relative flex items-center justify-center max-w-5xl mx-auto">
                    ...
                    <div class="relative z-20">
                        <img src="assets/images/irctc/banner.png" alt="Dashboard" class="h-96 mx-auto" />
...
<section>
  <div class="w-full bg-secondary-600 py-12">
    <div
    ...
    >
      ...
      <div class="hidden md:flex items-center justify-end space-x-6 text-sm">
        ...
        <div class="flex items-center">
          <span class="whitespace-nowrap">Quick Ticket Booking</span>
        </div>
        <div class="text-white/50">|</div>
        <div class="flex items-center">
          <span class="whitespace-nowrap">Real-time PNR Status </span>
        </div>
        <div class="text-white/50">|</div>
        <div class="flex items-center">
          <span class="whitespace-nowrap">Instant Refunds</span>
        </div>
        <div class="text-white/50">|</div>
        <div class="flex items-center">
          <span class="whitespace-nowrap">Multi-city Support</span>
        </div>
      </div>
  ...
  <div class="max-w-6xl mx-auto">
    <div class="flex flex-col md:flex-row items-center">
      ...
      <div class="w-full md:w-1/2 mb-8 md:mb-0 relative">
        <!-- Main photo -->
        <div class="bg-red-50/50 rounded-3xl p-6 relative">
        <img src="assets/images/irctc/irctc.png" alt="E-commerce services" class="w-full h-auto" onerror="this.onerror=null; this.src='/api/placeholder/550/350'; this.alt='E-commerce services placeholder'">
        </div>
      </div>
      
      <!-- Right Content Column -->
      <div class="w-full md:w-1/2 md:pl-12">
        <h2 class="text-3xl md:text-4xl font-bold text-primary-800 mb-8">
          Sec2Pay IRCTC<br>Platfrom Features
        </h2>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-start">
            ...
            <img src="assets/images/irctc/icon1.svg" alt="E-commerce services">
            </div>
            <div>
              <h3 class="text-lg font-semibold text-primary-700 mb-1">Train Booking</h3>
              <p class="text-gray-600 text-sm">
                Process train reservations within minutes through our platform. Give your customers the power to book tickets from any location, at any time.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            <div class="w-12 h-12 bg-primary-500 rounded-lg flex items-center justify-center text-white mr-4 flex-shrink-0">
            <img src="assets/images/irctc/icon2.svg" alt="E-commerce services">
            </div>
            <div>
              <h3 class="text-lg font-semibold text-primary-700 mb-1">PNR Status</h3>
              <p class="text-gray-600 text-sm">
                Help customers track their journey details instantly. Our platform provides real-time updates on ticket confirmation, coach, and seat details.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            <div class="w-12 h-12 bg-primary-500 rounded-lg flex items-center justify-center text-white mr-4 flex-shrink-0">
            <img src="assets/images/irctc/icon3.svg" alt="E-commerce services">
            </div>
            <div>
              <h3 class="text-lg font-semibold text-primary-700 mb-1">Refund Processing</h3>
              <p class="text-gray-600 text-sm">
                Handle cancellations and refunds smoothly. Our system manages the entire process, ensuring your customers receive their refunds quickly.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            <div class="w-12 h-12 bg-primary-500 rounded-lg flex items-center justify-center text-white mr-4 flex-shrink-0">
            <img src="assets/images/irctc/icon4.svg" alt="E-commerce services">
            </div>
            <div>
              <h3 class="text-lg font-semibold text-primary-700 mb-1">Multi-city Support</h3>
              <p class="text-gray-600 text-sm">
                Serve customers traveling between any stations across India. Our platform covers all major and minor railway stations nationwide.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-1/2 pr-0 md:pr-8 mb-8 md:mb-0">
                    <h2 class="text-4xl font-bold text-[#1F3262] mb-8">Benefits to IRCTC
                    Agents:</h2>
                ...
                <div class="w-full md:w-1/2">
                    <div class=" p-8 rounded-xl">
                        <img src="assets/images/irctc/benefits.png" alt="E-commerce services" class="w-full h-auto" onerror="this.onerror=null; this.src='/api/placeholder/550/350'; this.alt='E-commerce services placeholder'">
                    </div>
                </div>
            </div>
        </div>
