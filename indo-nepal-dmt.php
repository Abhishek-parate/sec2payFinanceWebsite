...
<body class="bg-white font-inter">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="p-4 md:p-8 lg:p-12 pt-8" data-aos="fade-right" data-aos-duration="1000"
                            ...
                            <p class="font-bold text-primary-600 text-sm sm:text-base mb-2" data-aos="fade-up"
                                data-aos-delay="100" data-aos-duration="800" data-aos-once="true"> Indo- Nepal DMT
                            ...
                            <p class="black mb-6 sm:mb-8 text-sm sm:text-base" data-aos="fade-up" data-aos-delay="400"
                                ...
                                Register for Indo-Nepal DMT services and help your customers transfer <br> money to
                                their loved ones in Nepal
        ...
        <section class="bg-primary-100 px-4 md:px-24 mb-6 py-12">
            <div class="container mx-auto px-6 text-center">
                <h2 class="text-3xl font-bold text-primary-700 mb-6" data-aos="fade-up" data-aos-duration="800"
                    data-aos-once="true">
                    Why Choose Sec2Pay <span class="text-secondary-500">Indo-Nepal DMT Platform</span>
                </h2>
    ...
    <div class="max-w-6xl mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="w-full md:w-1/2 order-1 md:order-2" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true">
                <img src="assets/images/indo-nepal-dmt/simple-easy.png" alt="Life Insurance" class="w-full h-auto">
            </div>

            <!-- Left side with content (second on mobile) -->
            <div class="w-full md:w-1/2 order-2 md:order-1" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                <h2 class="text-3xl font-bold text-gray-900 mb-6 mt-6" data-aos="fade-up" data-aos-delay="100">Support for Partners</h2>
                ...
                <ul class="space-y-5 mb-8">
                    ...
                    foreach ($healthPlans as $index => $plan) :
                        $delay = 200 + ($index * 100);
                    ?>
                    <li class="flex items-start" data-aos="fade-up" data-aos-delay="<?php echo $delay; ?>" data-aos-duration="800" data-aos-once="true">
