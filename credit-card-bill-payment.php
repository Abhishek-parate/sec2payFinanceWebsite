...
<body class="bg-white font-inter">
    ...
    <main class="overflow-hidden">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="p-4 md:p-8 lg:p-12 pt-8 md:w-1/2" data-aos="fade-right" data-aos-duration="1000"
                            ...
                            <p class="text-gray-700 mb-6 sm:mb-8 text-sm sm:text-base" data-aos="fade-up"
                                ...
                                Enable your customers to pay credit card bills from multiple banks <br> through a single
                            ...
                            <a href="https://app.sec2pay.in/?src=website" target="_blank"
                                ...
                                Start Now <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2"
        ...
        <!-- First section already has animations -->
