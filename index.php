...
<body class="bg-white font-inter">
    ...
    <main>
        ...
        <section class="relative overflow-hidden py-10 pt-16 md:pt-24 md:py-12 bg-white">
            <!-- For example, update your top gradient elements: -->
            <div class="pointer-events-none hidden sm:block absolute top-1/4 -translate-y-1/2 -left-[23%] w-[50%] h-[50%] rounded-full 
sm:-translate-y-0 sm:-top-[4%]"
            ...
            <div class="pointer-events-none hidden sm:block absolute top-1/4 -translate-y-1/2 -right-[20%] w-[50%] h-[50%] rounded-full
sm:-translate-y-0 sm:-top-[4%]"
            ...
            <div class="container mx-auto px-4 sm:px-6 relative z-20">
                ...
                <div class="max-w-4xl mx-auto text-center mb-8 md:mb-12 lg:mb-16 mt-2 md:mt-8">
                    ...
                    <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="200" data-aos-mirror="true">
                        <!-- Modify your button code like this -->
                ...
                <div class=" pointer-events-none  absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[70%] h-[70%] rounded-full z-10"
        ...
        <section class="py-10 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-2 md:gap-6 w-full">
                    ...
                    <div data-aos="fade-up" data-aos-duration="800"
                        ...
                        <div class="max-w-md relative z-10">
                            <h3 class="text-xl font-bold mb-4" data-aos="fade-right" data-aos-delay="100">Our Impact
                            </h3>

                            <h4 class="text-md font-medium mb-6 w-full md:w-[80%]" data-aos="fade-right"
                                data-aos-delay="200">
                            ...
                            <p class="text-white/90 w-[70%] md:w-[70%]" data-aos="fade-right" data-aos-delay="300">
                                From Banking services to Wealth management, we've been making essential services
                                accessible
                                since 2017. Our network serves 1 crore+ customers through tech-enabled financial
                                solutions.
                            </p>
                        </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="200"
                        ...
                        <div class="absolute z-0 opacity-30 right-0 max-w-full">
                            <img src="assets/images/home/svg/white-bg-bot.svg" alt="Background pattern"
                                class="w-full h-auto">
                        </div>

                        <div class="relative z-10 mb-6 md:mb-8 md:w-96">
                            <h4 class="text-xl font-semibold mb-6 md:mb-8" data-aos="fade-left" data-aos-delay="100">
                                Making
                        ...
                        <!-- CTA Button -->
                        <a href="https://app.sec2pay.in/?src=website" target="_blank" data-aos="fade-up"
                            data-aos-delay="600"
                        ...
                        <div class="absolute right-0 bottom-0 max-w-[50%] sm:max-w-full" data-aos="fade-up"
                            data-aos-delay="700">
                            <img src="assets/images/home/svg/red-graph.svg" alt="Graph illustration"
                                class="w-full h-auto">
                        </div>
                    </div>
        ...
        <section class="py-10 bg-white px-4">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-primary-800 mb-4">Our Product/Solutions</h2>
                    <p class="text-lg text-gray-700 max-w-3xl mx-auto">Building trust through partnerships that last
                        Creating a
                ...
                <div
                    class="flex overflow-x-auto lg:grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-4 lg:gap-6 p-2 lg:mx-0 scrollbar-hide">
                    <!-- Banking Card -->
                    <div
                    ...
                    <div
                        ...
                        <h3 class="font-semibold text-sm text-primary-600 text-center truncate w-full">Travel Booking
                        </h3>
                    </div>
                    ...
                    <div
                        ...
                        <h3 class="font-semibold text-sm text-primary-600 text-center truncate w-full">Utility Payment
                        </h3>
                    </div>
                    ...
                    <div
                        ...
                        <h3 class="font-semibold text-sm text-primary-600 text-center truncate w-full">Insurance
                            Services</h3>
                    </div>
            ...
            <div>
                ...
                <div class="product-content max-w-7xl mx-auto py-4 animate-fade-in">
                    <div class="rounded-xl overflow-hidden bg-gradient-to-r from-red-50 to-red-100 shadow-md">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="p-8 md:p-12">
                                ...
                                <p class="text-gray-700 mb-4">Expand your reach with AePS, UPI, and Micro ATM services.
                                </p>
                    ...
                    <div class="rounded-xl overflow-hidden bg-gradient-to-r from-red-50 to-red-100 shadow-md">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="p-8 md:p-12">
                                ...
                                <p class="text-gray-700 mb-4">Simplify travel bookings with IRCTC, flights, and buses.
                                </p>
                                <div class="space-y-4">
                                    <!-- Service Items -->
                                    <div class="flex items-start">
                            ...
                            <div class="relative h-48 sm:h-64 md:h-auto">
                                <img src="assets/images/home/travel-solutions.png"
                                    alt="Man using banking services on smartphone"
                                    class="w-full h-auto object-contain md:object-contain md:absolute md:bottom-0 md:right-0 lg:bottom-0" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-content max-w-7xl mx-auto py-4 animate-fade-in">
                    <div class="rounded-xl overflow-hidden bg-gradient-to-r from-red-50 to-red-100 shadow-md">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <!-- Right Content - Image -->
                            <div class="relative h-48 sm:h-64 md:h-auto">
                                <img src="assets/images/home/utility-&-bill.png"
                                    alt="Man using banking services on smartphone"
                                    class="w-full h-full object-contain md:object-contain md:absolute md:bottom-0 md:right-0" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="product-content max-w-7xl mx-auto py-4 animate-fade-in">
                    <div class="rounded-xl overflow-hidden bg-gradient-to-r from-red-50 to-red-100 shadow-md">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <!-- Right Content - Image -->
                            <div class="relative h-48 sm:h-64 md:h-auto">
                                <img src="assets/images/home/e-governance.png"
                                    alt="Man using banking services on smartphone"
                                    class="w-full h-full object-contain md:object-contain md:absolute md:bottom-0 md:right-0" />
                            </div>
                        </div>
                ...
                <div class="product-content max-w-7xl mx-auto py-4 animate-fade-in">
                    <div class="rounded-xl overflow-hidden bg-gradient-to-r from-red-50 to-red-100 shadow-md">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <!-- Right Content - Image -->
                            <div class="relative h-48 sm:h-64 md:h-auto">
                                <img src="assets/images/home/ondc-platform.png"
                                    alt="Man using banking services on smartphone"
                                    class="w-full h-full md:pt-4 object-contain md:object-contain md:absolute md:bottom-0 md:right-0" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mx-auto max-w-7xl">
                    <div class="text-center mb-8 md:mb-12" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <p class="text-base md:text-lg text-gray-700 max-w-3xl mx-auto">Building trust through
                            partnerships that
                            last. Creating a
                            network that serves millions.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pb-10 md:pb-20">
                        ...
                        <div class="bg-secondary-500 rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105 flex flex-col"
                            ...
                            <div class="mt-auto relative">
                                <div class="absolute top-2 right-2 w-3 h-3 bg-white rounded-full opacity-70"
                        ...
                        <div class="bg-blue-900 rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105 flex flex-col"
                            ...
                            <div class="mt-auto relative">
                                <div class="absolute top-2 right-2 w-1 h-1 bg-white rounded-full opacity-70"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center md:space-x-4 lg:space-x-8 mb-12">
                    ...
                    <div class="flex flex-col items-center mb-8 md:mb-0" data-aos="fade-right" data-aos-duration="1000"
                        ...
                        <p class="text-blue-100 text-center" data-aos="fade-up" data-aos-delay="500">Choose from our
                            flexible
                            options</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center mb-8 md:mb-0" data-aos="fade-up" data-aos-duration="1000"
                        ...
                        <h3 class="text-xl font-bold mb-2" data-aos="fade-up" data-aos-delay="600">Complete
                            Documentation</h3>
                        <p class="text-blue-100 text-center" data-aos="fade-up" data-aos-delay="700">Hassle-free and
                            fast</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center mb-8 md:mb-0" data-aos="fade-left" data-aos-duration="1000"
                        ...
                        <h3 class="text-xl font-bold mb-2" data-aos="fade-up" data-aos-delay="800">Launch Your Platform
                        </h3>
                        <p class="text-blue-100 text-center" data-aos="fade-up" data-aos-delay="900">Start offering
                            services
                            immediately.</p>
                    </div>
                </div>
        ...
        <section class="bg-white py-10">
            <div class="container mx-auto px-6">
                ...
                <p class="text-center font-semibold text-gray-600 mb-6" data-aos="fade-up" data-aos-delay="100">Hear
                    from our
                    partners across India</p>

                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden relative " data-aos="fade-up"
                        data-aos-delay="200">
                        ...
                        <div class="absolute bottom-0 items-center justify-center mx-4">
                            ...
                            <p class=" text-white text-lg font-semibold">"It's a low-code platform that helps us
                                automate
                                processes."</p>
        ...
        <section class="bg-white py-10">
            <div class="container mx-auto px-6 text-center">
                ...
                <p class="text-center font-semibold text-gray-600 mb-6" data-aos="fade-up" data-aos-delay="100">Hear from our partners across
                    India</p>
                ...
                <div class="flex justify-center items-center gap-2 mt-6">
                    <button id="indicator-0"
                        class="indicator-btn w-8 h-1 bg-secondary-500 rounded transition-all duration-300"
                        data-index="0" aria-label="Go to slide 1"></button>
                    <button id="indicator-1"
                        class="indicator-btn w-2 h-2 bg-gray-300 rounded-full transition-all duration-300"
                        data-index="1" aria-label="Go to slide 2"></button>
                    <button id="indicator-2"
                        class="indicator-btn w-2 h-2 bg-gray-300 rounded-full transition-all duration-300"
                        data-index="2" aria-label="Go to slide 3"></button>
                    <button id="indicator-3"
                        class="indicator-btn w-2 h-2 bg-gray-300 rounded-full transition-all duration-300"
                ...
                contentSections.forEach((section) => {
                    if (!section.classList.contains("hidden")) {
                        ...
                        setTimeout(() => {
                            ...
                            contentSections[index].classList.add(
                                "animate-slide-in");

                            // Remove animation class after it completes
                            setTimeout(() => {
                                contentSections[index].classList.remove(
                                    "animate-slide-in");
                            }, 400);
    ...
    `;
        ...
        function updateCarousel(animate = true) {
            ...
            const gapWidth = marginRight ||
                24; // Default to 24px if no margin is detected (Tailwind's space-x-6)
