    ...
    <main>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-6 w-full">
                    ...
                    <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="200"
                        class="col-span-1 md:col-span-3 bg-gradient-to-br from-primary-800 to-primary-500 rounded-xl p-6 md:p-10 text-white relative overflow-hidden mt-6 md:mt-0">
                        ...
                        <!-- Decorative Red Line/Graph - Positioned in background for all devices -->
                        <div class="absolute right-0 bottom-0 w-1/2 sm:w-1/2 z-0">
                            <img src="assets/images/home/svg/red-graph-up.svg" alt="Graph illustration"
                                class="w-full h-auto">
                        </div>

                        <div class="relative z-10 mb-6 md:mb-8">
                            <h4 class="text-xl font-semibold mb-6 md:mb-8">
                                Making Financial Services Accessible Since 2017
                            </h4>

                            <div class="grid grid-cols-2 gap-x-4 gap-y-4 mb-8 md:w-96">
                                <!-- Stats Row 1 -->
                                <div class="flex flex-col">
                                    <p class="text-2xl font-bold">1 Lacs+</p>
                                    <p class="text-blue-200/70 text-sm -mt-1">Active retailers</p>
                                </div>
                                <div class="flex flex-col">
                                    <p class="text-2xl font-bold">1000+</p>
                                    <p class="text-blue-200/70 text-sm -mt-1">Business Partners</p>
                                </div>

                                <!-- Stats Row 2 -->
                                <div class="flex flex-col">
                                    <p class="text-2xl font-bold">20+</p>
                                    <p class="text-blue-200/70 text-sm -mt-1">Banking Partners</p>
                                </div>
                                <div class="flex flex-col">
                                    <p class="text-2xl font-bold">1 Cr+</p>
                                    <p class="text-blue-200/70 text-sm -mt-1">End Customers served</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="#" data-aos="fade-up" data-aos-delay="600"
                            class="relative z-10 inline-flex items-center bg-secondary-500 hover:bg-secondary-600 text-white px-5 py-2 md:px-6 md:py-3 rounded-lg font-semibold transition-all">
                            Join today for free
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pb-10 md:pb-20">
                        ...
                        <div class="bg-secondary-500 rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105 flex flex-col"
                            ...
                            <div class="mt-auto relative ">
                                ...
                                <div class="h-48 overflow-hidden bottom-0 ">
        ...
        <section class="bg-white py-10">
            <div class="container mx-auto px-6">
                ...
                <p class="text-center font-semibold text-gray-600 mb-12" data-aos="fade-up" data-aos-delay="100">Hear
                    from our
        ...
        <section class="bg-white py-10">
            <div class="container mx-auto px-6 text-center">
                ...
                <p class="text-gray-600 mb-12" data-aos="fade-up" data-aos-delay="100">Hear from our partners across
                    India</p>
