...
<section class="relative overflow-hidden py-10 pt-20 md:pt-24 md:py-10 bg-white">
   ...
   <!-- Centered Retail Partner Avatars Block -->
<div class="flex justify-center mt-4" data-aos="fade-up" data-aos-delay="200">
    <div class="flex gap-2 border-2 justify-center items-center border-gray-200 rounded-full p-2 w-full max-w-sm shadow-sm text-center">
        ...
        <span class="text-gray-600 text-sm ml-2">1 Lac+ Retail partners across India</span>
    </div>
</div>
...
<div class="relative max-w-full mx-auto  overflow-hidden z-10" data-aos="zoom-in" data-aos-duration="1000"
            ...
            <div class="relative z-20">
                <img src="./assets/images/odnc-credit-box/odncbox-hero.png" alt="Dashboard" class="w-full h-auto" />
            </div>
        </div>
