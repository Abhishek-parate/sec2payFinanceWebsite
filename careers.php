    ...
    <div class="rounded-xl overflow-hidden">
      <div class="flex flex-col items-center text-center">
        ...
        <div class="p-8 md:p-12 mt-12 max-w-2xl">
          <h1 class="text-4xl font-bold text-secondary-600">Join Our Mission to Transform Financial Services</h1>
          <p class="text-primary-500 font-bold">We help, We grow, We prosper</p>
          <p class="text-gray-500 mb-8">At Sec2Pay, we're bringing financial services closer to millions across India. As we grow, we're looking for passionate individuals who want to make a real difference in how businesses serve their communities.</p>
...
<section class="bg-secondary-100 py-10 px-4 md:px-24">
    <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold text-primary-700 my-8 text-center">Why Join us</h2>
...
<section>
  <div class="w-full bg-secondary-600 py-12 mt-6">
    <div
