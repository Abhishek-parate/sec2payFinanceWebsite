...
<body class="bg-white font-inter">
    ...
    <main>
        ...
        <!-- hero section -->
        <section class="bg-white overflow-hidden hero-section py-6 sm:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="rounded-xl">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <!-- Left Content - Services List -->
                        <div class="p-4 sm:p-6 lg:p-8 order-2 lg:order-1" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                            <p class="font-bold text-primary-600 text-sm sm:text-base">Banking Platform Services</p>
                            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-600 mt-2">Transform Your Business</h1>
                            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-600 mb-3 sm:mb-4">Into a Banking Hub</h1>
                            <p class="text-gray-500 mb-6">Empower your business to create seamless shopping experiences for buyers.</p>
        ...
        <section class="relative py-12 md:py-16">
            ...
            <div class="relative container mx-auto max-w-6xl px-4 sm:px-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12 relative" style="top: calc(60% - 12rem);">
                    <!-- Feature 1 -->
                    <div class="bg-white rounded-xl p-6 md:p-8 shadow-sm border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <!-- Feature 2 -->
                    <div class="bg-white rounded-xl p-6 md:p-8 shadow-sm border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                        <p class="text-gray-600">
                    ...
                    <!-- Feature 3 -->
                    <div class="bg-white rounded-xl p-6 md:p-8 shadow-sm border border-gray-100" data-aos="fade-up" data-aos-delay="300">
                        <p class="text-gray-600">
                ...
                <!-- CTA Button -->
                <div class="text-center relative" style="top: calc(60% - 12rem);" data-aos="zoom-in" data-aos-delay="400">
                    <a href="#" class="inline-block bg-secondary-500 hover:bg-secondary-600 text-white font-medium py-3 px-6 md:px-8 rounded-md transition duration-300">
                        Discover More
                    </a>
                </div>
            </div>
        ...
        <section class="relative py-8 md:py-10 px-4 sm:px-8 md:px-16 lg:px-20">
            <div class="container mx-auto">
                ...
                <div class="bg-gradient-to-br from-primary-700 to-primary-600 rounded-xl p-6 sm:p-8 md:p-10 text-white relative overflow-hidden"
                    ...
                    <div class="max-w-4xl mx-auto text-center">
                        <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4 relative z-10"
                            data-aos="fade-up" data-aos-delay="200">
                            Join Sec2pay today
                        </h1>

                        <p class="text-sm sm:text-base md:text-lg text-gray-300 mb-6 sm:mb-8 relative z-10" data-aos="fade-up"
                            data-aos-delay="300">
                        ...
                        <div class="relative z-10" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <a href="#"
                                class="inline-flex items-center bg-secondary-500 hover:bg-secondary-600 text-white px-4 sm:px-5 md:px-6 py-2 sm:py-3 rounded-lg font-semibold transition-all transform hover:scale-105"
