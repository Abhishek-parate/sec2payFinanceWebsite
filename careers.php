      ...
      <div class="max-w-7xl mx-auto py-12">
        <div class="rounded-xl overflow-hidden">
          <div class="flex flex-col items-center text-center">
            ...
            <div class="p-8 md:p-12 mt-12 max-w-6xl">
              <h1 class="text-5xl font-bold text-secondary-600">Join Our Mission to Transform Financial Services</h1>
              <p class="text-primary-500 font-bold">We help, We grow, We prosper</p>
              <p class="text-gray-500 mb-8">At Sec2Pay, we're bringing financial services closer to millions across India. <br> As we grow, we're looking for passionate individuals who want to make a real <br> difference in how businesses serve their communities.</p>
