        ...
        <div class="rounded-xl overflow-hidden ">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-8 md:p-12 mt-12">
                    <p class="font-semi-bolder text-primary-600 font-bold">Credit Card Bill Payment Platform</p>
                    <h1 class="text-4xl font-bold text-secondary-500 ">Pay credit card bills</h1>
                    <h1 class="text-4xl font-bold text-secondary-500 mb-4">instantly through our</h1>
                    <h1 class="text-4xl font-bold text-secondary-500 ">secure platform</h1>
                    <p class="text-gray-500 mb-8">Enable your customers to pay credit card bills from multiple banks through a single interface. Join our network of trusted partners.</p>
