        ...
        <div class="rounded-xl overflow-hidden  ">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-8 md:p-12 mt-12">
                    ...
                    <p class="text-gray-500 mb-8">Transform your store into a secure money transfer hub with our DMT platform.</p>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="p-6 text-left">
                                <h3
                                    class="text-secondary-600 font-semibold text-xl mb-2">Quick
                                    Transfer</h3>
