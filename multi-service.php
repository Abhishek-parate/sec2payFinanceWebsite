...
<section class="relative overflow-hidden py-10 pt-20 md:pt-24 md:py-10 bg-white">
  ...
  <div class="flex items-center mt-4">
    ...
    <div class="flex items-center mx-1">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400" viewBox="0 0 24 24">
        ...
        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" fill="currentColor" clip-path="inset(0 50% 0 0)"/>
      </svg>
    </div>
...
<section class="py-12">
    <div class="max-w-7xl mx-auto bg-gray-100 rounded-xl shadow-sm overflow-hidden">
        <div class="flex flex-col md:flex-row">
            <!-- Left Sidebar with Tabs -->
            <div class="bg-gray-100 w-full md:w-1/3 p-4 mt-4">
            <div class=" bg-white rounded-xl">
                <!-- Tab items -->
                <div class="space-y-4">
                    <button class="tab-button w-full flex items-center p-4 rounded-lg bg-red-100 text-gray-900 hover:bg-red-50 focus:outline-none transition duration-200 active" data-tab="banking">
                    ...
                    <button class="tab-button w-full flex items-center p-4 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none transition duration-200" data-tab="travel">
                        <div class="flex-shrink-0 mr-3">
                            <svg class="w-6 h-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button class="tab-button w-full flex items-center p-4 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none transition duration-200" data-tab="utility">
                        <div class="flex-shrink-0 mr-3">
                            <svg class="w-6 h-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button class="tab-button w-full flex items-center p-4 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none transition duration-200" data-tab="governance">
                        <div class="flex-shrink-0 mr-3">
                            <svg class="w-6 h-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <button class="w-auto bg-secondary-500 hover:bg-secondary-600 text-white py-3 px-6 rounded-xl transition-all font-medium">
            ...
            <div class="w-full md:w-2/3 p-0">
                ...
                <div id="banking-content" class="tab-content active">
                    <div class="p-6">
                        ...
                        <p class="text-gray-700 mb-6">Deliver core banking functionalities such as AePS, UPI, and Micro ATM services to enhance your network</p>
                        <!-- Person image -->
                        <img src="assets\images\multi-service\banking-sevices.png" alt="Banking Services" class="w-full h-full object-cover object-center p-3" />
                    </div>
                </div>
                ...
                <div id="travel-content" class="tab-content">
                    <div class="p-6">
                        ...
                        <p class="text-gray-700 mb-6">Comprehensive travel booking services including flights, trains, buses and hotels to expand your service offerings</p>
                        <!-- Person image -->
                        <img src="assets\images\multi-service\travel-solution.png" alt="Travel Solutions" class="w-full h-full object-cover object-center p-3" />
                    </div>
                </div>
                ...
                <div id="utility-content" class="tab-content">
                    <div class="p-6">
                        ...
                        <p class="text-gray-700 mb-6">Simplify bill payments with our comprehensive platform for electricity, water, gas, and more</p>
                        <!-- Person image -->
                        <img src="assets\images\multi-service\bill-payments.png" alt="Utility Services" class="w-full h-full object-cover object-center p-3" />
                    </div>
                </div>
                ...
                <div id="governance-content" class="tab-content">
                    <div class="p-6">
                        ...
                        <p class="text-gray-700 mb-6">Facilitate access to essential government services and digital document processing</p>
                        <!-- Person image -->
                        <img src="assets\images\multi-service\e-governance.png" alt="E-Governance Services" class="w-full h-full object-cover object-center p-3" />
                    </div>
                </div>
            </div>
        </div>
