...
<body class="bg-white font-inter">
    ...
    <main class="overflow-hidden">
        ...
        <section class="relative overflow-hidden bg-white py-6 sm:py-8 md:py-10">
            ...
            <div class="hidden sm:block absolute -top-[4%] -left-[23%] w-[50%] h-[50%] rounded-full"
                style="background: radial-gradient(circle, rgba(230, 120, 120, 0.8) 0%, rgba(242, 219, 219, 0.4) 40%, rgba(255, 255, 255, 0) 70%);">
            </div>

            <div class="hidden sm:block absolute -top-[4%] -right-[20%] w-[50%] h-[50%] rounded-full"
                style="background: radial-gradient(circle, rgba(126, 194, 240, 0.8) 0%, rgba(222, 242, 255, 0.4) 40%, rgba(255, 255, 255, 0) 70%);">
            </div>

            <div class="hidden sm:block absolute top-10 md:top-[10%] left-2 md:left-10 lg:left-24 opacity-80 w-24 md:w-32 lg:w-auto z-10"
            ...
            <div class="hidden sm:block absolute top-10 md:top-[10%] right-2 md:right-10 lg:right-24 opacity-80 w-24 md:w-32 lg:w-auto z-10"
    ...
    <div class="relative container mx-auto max-w-6xl px-4">
        ...
        <div class="text-center mb-12 z-10 relative" data-aos="fade-up">
            ...
            <p class="text-black text-xl max-w-4xl mx-auto text-center leading-relaxed">
                Sec2Pay's Insurance Platform provides businesses with the ability to integrate a variety of
