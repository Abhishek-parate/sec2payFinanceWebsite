...
<section class=" py-10 px-4 md:px-24">
    <div class="container mx-auto px-6 ">
        <h2 class="text-3xl font-bold text-primary-700 mb-8 text-center">Services</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-8">
              ...
              <p>Our platform enables your customers to compare and choose from multiple term insurance plans. Simple documentation process with quick policy issuance.</p>         </div>
            <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-8">
                <!-- Icon and Title - Vertical Alignment -->
                <div class="text-left mb-2">
                    <h2 class="text-xl font-semibold text-red-500">Whole Life Insurance</h2>
                </div>
                <p>Help customers build a financial safety net with whole life insurance plans that offer lifelong protection and savings benefits.</p>            </div>
            <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-8">
                <!-- Icon and Title - Vertical Alignment -->
                <div class="text-left mb-2">
                    <h2 class="text-xl font-semibold text-red-500">Child Insurance Plans</h2>
                </div>
                <p>Offer specialized plans designed to secure children's future education and life goals, with flexible premium payment options.</p>     </div>
...
<section class="min-h-[350px] py-12 flex items-center">
...
<!-- Banking Services Section --> 
<section class="min-h-[350px] pb-6 flex items-center">
    <div class="container mx-auto px-4 md:px-6">
        <!-- Banking Services Tabs -->
        <div class="w-full" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            <!-- Tab Content -->
            <div class="relative min-h-[350px] overflow-hidden md:pl-24">
                ...
                <div class="tab-pane block opacity-100 transition-opacity duration-300" id="aeps">
                    ...
                    <div class="w-full md:w-1/2 pl-12">
                            <h3 class="text-2xl md:text-3xl font-semibold mb-8  text-primary-600">Key Features:</h3>
                            <ul class="space-y-5 mb-4">
                                <?php
                                $lifePlans = [
...
<rect width="19" height="19" fill="white" transform="translate(0 3)"/>
                        ...
                        <div class="w-full md:w-1/2 flex justify-center">
                            <div class="relative flex justify-center" data-aos="fade-left" data-aos-duration="1000">
                                <img src="assets/images/life-insurance/features.png" alt="AePS Banking"
                                    class="max-w-full h-auto max-h-[400px]">
                            </div>
                        </div>
