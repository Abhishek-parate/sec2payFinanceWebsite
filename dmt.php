        ...
        <div class="rounded-xl overflow-hidden  ">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-8 md:p-12 mt-12">
                    ...
                    <h1 class="text-4xl font-bold text-secondary-500 ">Money Transfer</h1>
                    <h1 class="text-4xl font-bold text-secondary-500 mb-4">Platform</h1>
                    <p class="text-gray-500 mb-8">Transform your store into a secure money transfer hub with our DMT
                        platform.</p>
...
<section class="py-12 mb-12 mt-6 bg-primary-100">
    <div class="max-w-6xl mx-auto px-4">
        <h2 class="text-3xl md:text-4xl font-bold text-primary-500 mb-8">Why Choose Sec2Pay DMT Platform Service</h2>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Feature 1 - Secure Payments -->
            <div class="rounded-lg border border-primary-500 bg-primary-200 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div
                ...
                <div class="p-6 text-left">
                    ...
                    <p class="text-gray-600 text-sm">
                        Process domestic money transfers swiftly with minimal steps. Your customers can send money to
            ...
            <div
                ...
                <div class="p-6 text-left ">
                    ...
                    <h3 class="text-secondary-600 font-semibold text-xl mb-2">Status
                        Tracking</h3>
                    <p class="text-gray-600 text-sm">
                        Monitor transfer status in real-time. Get instant updates on successful transfers or any issues
                        that need attention.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="p-6 text-left ">
                    ...
                    <p class="text-gray-600 text-sm">
                        Earn competitive commissions on every successful transaction. Watch your business grow with our
            ...
            <div
                ...
                <div class="p-6 text-left  ">
                    ...
                    <h3 class="text-secondary-600 font-semibold text-xl mb-2">Settlement
                        System</h3>
                    <p class="text-gray-600 text-sm">
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="w-full md:w-1/2">
                <img src="assets/images/dmt/benefits.png" alt="Life Insurance">
            </div>
