...
<section class="py-12 mb-12 mt-6 bg-primary-600">
        ...
        <div class="container mx-auto px-4 md:px-6">
            ...
            <div class="w-full" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                ...
                <div class="flex flex-wrap mb-8 gap-2 md:gap-3">
                    <button
                        class="tab-btn px-5 py-3 bg-secondary-500 text-white border border-primary-300 rounded-full cursor-pointer text-sm font-medium transition-all duration-300 outline-none"
                        data-tab="mobile-dth">
                        <span>Area Partner</span>
                    </button>
                    <button
                        class="tab-btn px-5 py-3 bg-transparent border border-gray-300 rounded-full cursor-pointer text-sm font-medium transition-all duration-300 outline-none"
                        data-tab="mobile-dth">
                        <span class="text-primary-500">Mobile & DTH</span>
                    </button>
                    <button
                        ...
                        data-tab="fastag">
                        <span class="text-primary-500"t>FASTag Services</span>
                    </button>
                </div>
                    ...
                    <div class="tab-pane block opacity-100 transition-opacity duration-300" id="essential-bills">
                        <div class="flex flex-col md:flex-row items-center gap-8">
                            <div class="w-full md:w-1/2 p-6">
                                <h3 class="text-2xl md:text-3xl font-semibold mb-4 text-secondary-600">Operate in a single location
                                with essential tools.</h3>
                                <ul class="space-y-4">
                                    <li class="flex items-center">
                                        ...
                                        <span class="text-gray-700">Single area rights</span>
                                    </li>
                                    <li class="flex items-center">
                                        <span class="inline-flex items-center justify-center w-6 h-6 bg-primary-600 text-white rounded-full mr-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <span class="text-gray-700">Basic delivery management tools</span>
                                    </li>
                                    <li class="flex items-center">
                                        <span class="inline-flex items-center justify-center w-6 h-6 bg-primary-600 text-white rounded-full mr-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <span class="text-gray-700">Standard customer support</span>
                                    </li>
                                    <li class="flex items-center">
                                        <span class="inline-flex items-center justify-center w-6 h-6 bg-primary-600 text-white rounded-full mr-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <span class="text-gray-700">Fixed commission structure</span>
                                    </li>
                                    <li class="flex items-center">
                                        <span class="inline-flex items-center justify-center w-6 h-6 bg-primary-600 text-white rounded-full mr-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <span class="text-gray-700">Training and onboarding support</span>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="bg-primary-100 rounded-xl p-8 md:p-12">
            <div class="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div class="w-full md:w-1/2">
                    <h2 class="text-3xl md:text-4xl font-bold text-secondary-500 mb-8">Platform Services</h2>
                    <ul class="space-y-5">
                        <!-- Service Item 1 -->
                        <li class="flex items-center">
