...
<section class="relative overflow-hidden py-10 pt-20 md:pt-24 md:py-10 bg-white">
    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-20">
        ...
        <div class="relative max-w-5xl mx-auto  overflow-hidden z-10" 
             data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300" data-aos-mirror="true">
        ...
        <div class="mt-12 md:mt-16 text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400" data-aos-mirror="true">
            ...
            <div class="relative overflow-hidden w-full ">
                <div class="logos-container flex whitespace-nowrap">
                    ...
                    <div class="logos-slide animate-scroll inline-flex items-center">
                        ...
                        <img src="./assets/images/home/bom.png" alt="Bank of Maharashtra" class="h-8 md:h-10 w-auto mx-8" />
                        ...
                        <img src="./assets/images/home/sc.png" alt="Standard Chartered" class="h-8 md:h-10 w-auto mx-8" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 w-full">
            ...
            <div
                ...
                <div class="max-w-md relative z-10">
                    ...
                    <h4 class="text-md font-medium mb-6 w-full md:w-[80%]" data-aos="fade-right" data-aos-delay="200">Making Financial Services Accessible Since 2017</h4>
                ...
                <div class="absolute -right-10 sm:-right-20 bottom-0 h-48 sm:h-64 w-48 sm:w-64 opacity-90" data-aos="zoom-in" data-aos-delay="400">
            ...
            <div
                ...
                <div class="relative z-10 mb-6 md:mb-8">
                    <h4 class="text-xl font-semibold mb-6 md:mb-8" data-aos="fade-left" data-aos-delay="100">Making Financial Services Accessible Since 2017</h4>
...
<section class="py-10 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex overflow-x-auto lg:grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-4 lg:gap-6 pb-4 -mx-4 px-4 lg:mx-0 scrollbar-hide">
            <!-- Banking Card -->
            <div
    ...
    <div class="relative z-10 container px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-0 sm:mx-4 md:mx-10 lg:mx-20">
            <div class="text-center mb-8 md:mb-12" data-aos="fade-up" data-aos-duration="800">
                ...
                <p class="text-base md:text-lg text-gray-700 max-w-3xl mx-auto">Building trust through partnerships that last. Creating a
                    network that serves millions.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pb-10 md:pb-20">
                ...
                <div class="bg-blue-900 rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105"
                    ...
                    <div class="mt-2 relative">
                        <div class="absolute top-2 right-2 w-3 h-3 bg-white rounded-full opacity-70" data-aos="fade-in" data-aos-delay="300"></div>
                ...
                <div class="bg-secondary-500 rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105"
                    ...
                    <div class="mt-2 relative">
                        <div class="absolute top-2 right-2 w-3 h-3 bg-white rounded-full opacity-70" data-aos="fade-in" data-aos-delay="400"></div>
                        <img src="assets/images/home/dashboard-img.png" alt="Dashboard Interface"
                            class="w-full h-auto rounded" />
                    </div>
                </div>
                ...
                <div class="bg-blue-900 rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105"
                    ...
                    <div class="mt-2 relative">
                        <div class="absolute top-2 right-2 w-3 h-3 bg-white rounded-full opacity-70" data-aos="fade-in" data-aos-delay="500"></div>
                        <img src="assets/images/home/img-home.png" alt="Dashboard Interface"
                            class="w-full h-auto rounded" />
                    </div>
                </div>
...
<section class="bg-gradient-to-r from-primary-800 to-primary-600 py-16 text-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl font-bold mb-4" data-aos="fade-down" data-aos-duration="800">Getting Started</h2>
            <p class="text-lg text-blue-100 mb-12" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">Three Simple Steps to Join:</p>

            <div class="flex flex-col md:flex-row items-center justify-center md:space-x-4 lg:space-x-8 mb-12">
                <!-- Step 1 -->
                <div class="flex flex-col items-center mb-8 md:mb-0" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                    <div class="bg-secondary-500 rounded-lg p-4 mb-4 w-16 h-16 flex items-center justify-center transform transition-transform hover:scale-110" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <p class="text-blue-100 text-center" data-aos="fade-up" data-aos-delay="500">Choose from our flexible options</p>
                </div>
                ...
                <!-- Step 2 -->
                <div class="flex flex-col items-center mb-8 md:mb-0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                    <div class="bg-secondary-500 rounded-lg p-4 mb-4 w-16 h-16 flex items-center justify-center transform transition-transform hover:scale-110" data-aos="zoom-in" data-aos-delay="500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Step 3 -->
                <div class="flex flex-col items-center mb-8 md:mb-0" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="600">
                    <div class="bg-secondary-500 rounded-lg p-4 mb-4 w-16 h-16 flex items-center justify-center transform transition-transform hover:scale-110" data-aos="zoom-in" data-aos-delay="700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-blue-100 text-center" data-aos="fade-up" data-aos-delay="900">Start offering services immediately.</p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-6">
        ...
        <p class="text-center font-semibold text-gray-600 mb-12" data-aos="fade-up" data-aos-delay="100">Hear from our partners across India</p>
...
<section class="bg-white py-10">
    <div class="container mx-auto px-6 text-center">
        ...
        <div class="relative" data-aos="fade-up" data-aos-delay="200">
            <!-- Blog Carousel -->
            <div id="blog-carousel" class="flex overflow-x-auto md:overflow-hidden space-x-6 mb-8 mx-4 md:mx-16 scrollbar-hide pb-4 md:pb-0 snap-x snap-mandatory md:snap-none">                <!-- Blog Post 1 -->
                <div class="bg-gray-100 rounded-lg overflow-hidden shadow-sm w-full md:w-1/3 flex flex-col"  data-aos="zoom-in" data-aos-delay="100">
                    <div class="relative">
                ...
                <!-- Blog Post 2 -->
                <div class="bg-gray-100 rounded-lg overflow-hidden shadow-sm w-full md:w-1/3 flex flex-col" data-aos="zoom-in" data-aos-delay="200">
                    <div class="relative">
                        <div class="absolute top-4 left-4">
                            <span class="bg-red-500 text-white text-xs px-3 py-1 rounded">HEADLINE</span>
                        </div>
                ...
                <!-- Blog Post 3 -->
                <div class="bg-gray-100 rounded-lg overflow-hidden shadow-sm w-full md:w-1/3 flex flex-col" data-aos="zoom-in" data-aos-delay="300">
                    <div class="relative">
                        <div class="absolute top-4 left-4">
                            <span class="bg-red-500 text-white text-xs px-3 py-1 rounded">HEADLINE</span>
                        </div>
            ...
            <!-- Carousel Navigation -->
            <button id="prev-btn" class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-primary-100 hover:bg-primary-200 rounded-full p-2 sm:p-3 shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-300 z-10 hidden sm:block disabled:opacity-50 disabled:cursor-not-allowed" aria-label="Previous slide">

            <i class="fa fa-chevron-left h-6 w-6 text-blue-500" aria-hidden="true"></i>

            </button>
            <button id="next-btn" class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-primary-100 hover:bg-primary-200 rounded-full p-2 sm:p-3 shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-300 z-10 hidden sm:block disabled:opacity-50 disabled:cursor-not-allowed" aria-label="Next slide">
        ...
        <!-- Carousel Indicator -->
          <div class="flex justify-center items-center gap-2 mt-6">
            <button id="indicator-0" class="indicator-btn w-8 h-1 bg-secondary-500 rounded transition-all duration-300" data-index="0" aria-label="Go to slide 1"></button>
            <button id="indicator-1" class="indicator-btn w-2 h-2 bg-gray-300 rounded-full transition-all duration-300" data-index="1" aria-label="Go to slide 2"></button>
            <button id="indicator-2" class="indicator-btn w-2 h-2 bg-gray-300 rounded-full transition-all duration-300" data-index="2" aria-label="Go to slide 3"></button>
            <button id="indicator-3" class="indicator-btn w-2 h-2 bg-gray-300 rounded-full transition-all duration-300" data-index="3" aria-label="Go to slide 4"></button>
        </div>
    </div>
</section>
...
<section class="relative py-10 px-4 sm:px-8 md:px-16 lg:px-20">
    <div class="container mx-auto">
        ...
        <div 
            class="bg-gradient-to-br from-[#142344] to-[#3258AA] rounded-xl p-6 sm:p-8 md:p-10 text-white relative overflow-hidden"
            data-aos="fade-up"
            ...
            <div class="max-w-4xl mx-auto text-center">
                <h1 
                    class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4 relative z-10"
                    data-aos="fade-up"
                    data-aos-delay="200">
                    Join Sec2pay today
                </h1>
                ...
                <p 
                    class="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 relative z-10"
                    data-aos="fade-up"
                    data-aos-delay="300">
